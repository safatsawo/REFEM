...
<section class="page-content">
    ...
    <div class="row">
        <div class="column">
            ...
            <p>
                Thank you for serving with us as we honor God and make disciples. Please fill-up and send the form
                below.
            </p>
...
//    $query = "INSERT INTO refem_church(full_name, email, mobile_number, facebook_url,ministry_volunteer,first_time, comments)";
    // $query .= " VALUES ('{$full_name}','{$email}',$mobile_number,'{$facebook_url}','{$ministry_volunteer}','{$first_time}','{$comments}') ";
$query =  "INSERT INTO refem(full_name, email, facebook_url, ministry_volunteer, mobile_number, comments,first_time) VALUES ('{$full_name}','{$email}','{$facebook_url}','{$ministry_volunteer}','{$mobile_number}','{$comments}','{$first_time}') ";

    $create_refem = mysqli_query($connection, $query);
            ...
            <form name="volunteerForm" id="volunteerForm" class="volunteerForm" method="POST" action="volunteer.php"
                ...
                <fieldset>
                    ...
                    <div class="form-field">
                        <input name="full_name" id="full_name" class="h-full-width h-remove-bottom"
                            placeholder="Your Name" value="" type="text">
                    </div>

                    <div class="form-field">
                        <input name="email" id="email" class="h-full-width h-remove-bottom" placeholder="Your Email"
                            value="" type="text">
                    </div>

                    <div class="form-field">
                        <input name="mobile_number" id="mobile_number" class="h-full-width h-remove-bottom"
                            placeholder="Mobile Number" value="" type="tel">
                    </div>

                    <div class="form-field">
                        <input name="facebook_url" id="facebook_url" class="h-full-width h-remove-bottom"
                            placeholder="Facebook URL" value="" type="text">
                    </div>

                    <br>
                    <div class="form-field">
                        <label for="ministry_volunteer">Ministry to volunteer</label>
                        <div class="ss-custom-select">
                            <select class="h-full-width h-remove-bottom" name="ministry_volunteer"
                                id="ministry_volunteer">
                                <option>Ushering & Security</option>
                                <option>Kids Church</option>
                                <option>Music Team</option>
                                <option>Prayer Team</option>
                                <option>Administrative Support</option>
                                <option>Production Design</option>
                                <option>Technical & Stage Management</option>
                    ...
                    <div class="form-field">
                        <label for="first_Time">This is my first time to serve</label>
                        <div class="ss-custom-select">
                            <select class="h-full-width h-remove-bottom" name="first_time" id="first_time">
                                <option>Yes</option>
                                <option>No</option>
                            </select>
                        </div>
                    ...
                    <div class="comments form-field">
                        <textarea name="comments" id="comments" class="h-full-width h-remove-bottom"
                            placeholder="Comments & Questions"></textarea>
                    </div>

                    <br>

                    <button type="submit" name="submit" id="submit" class="btn btn--primary btn--large h-full-width"
                        value="Submit Form">SUBMIT</button>
